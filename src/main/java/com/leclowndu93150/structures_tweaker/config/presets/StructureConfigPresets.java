...
public class StructureConfigPresets {
    ...
    static {
        ...
        registerPreset("uas", "deep_spawner_1", protectedSpawnerChanges);
        registerPreset("uas", "deep_spawner_2", protectedSpawnerChanges);
        registerPreset("uas", "deep_spawner_3", protectedSpawnerChanges);
        registerPreset("uas", "deep_spawner_4", protectedSpawnerChanges);
    }
    ...
    /**
     * Helper method to create a preset with specific property values
     */
