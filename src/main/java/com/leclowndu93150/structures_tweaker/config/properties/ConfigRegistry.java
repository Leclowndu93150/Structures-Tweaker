...
public class ConfigRegistry {
    private static final Map<String, ConfigProperty<?>> PROPERTIES = new ConcurrentHashMap<>();
    ...
    public static final ConfigProperty<Boolean> CAN_INTERACT = register(
        "canInteract", true, Boolean.class, "Allow interacting with blocks in structure"
    );
    ...
    public static final ConfigProperty<Boolean> ALLOW_PLAYER_PVP = register(
        "allowPlayerPvP", true, Boolean.class, "Allow player vs player combat in structure"
    );
    ...
    public static final ConfigProperty<Boolean> ALLOW_EXPLOSIONS = register(
        "allowExplosions", true, Boolean.class, "Allow explosions to damage blocks in structure"
    );
    ...
    public static List<ConfigPropertyRegistration> getRegistrations() {
