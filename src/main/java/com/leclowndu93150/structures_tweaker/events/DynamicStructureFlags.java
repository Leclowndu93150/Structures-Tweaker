...
/**
 * Dynamic wrapper around StructureConfig that can be updated without recreating event handlers
 */
public class DynamicStructureFlags {
    ...
    public void updateFromConfig(StructureConfig config) {
        this.flags = config.getAllValues();
    }
